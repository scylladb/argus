...
def test_setup_argus_reporter_from_code(testdir, requests_mock):
    ...
    testdir.makepyfile(
        ...
        def configure_es(argus_reporter):
            ...
            argus_reporter.es_username = 'test'
...
def test_post_reports(testdir, requests_mock):  # pylint: disable=redefined-outer-name
    ...
    ), "Requests are made to Elasticsearch when post_reports is True"
...
def test_no_post_reports(
    ...
    ), "Requests are not made to Elasticsearch when post_reports is False"
