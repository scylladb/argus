...
def configure_es_mock(requests_mock):  # pylint: disable=redefined-outer-name
    ...
    requests_mock.get(
        ...
        response_list=[
            dict(
                json={"response": {"bootstrap_test.py::TestBootstrap::test_start_stop_node": {"duration": {"avg": 60.0 }}},"status": "ok"},
                status_code=200,
            ),
            dict(
                json={"response": {"bootstrap_test.py::TestBootstrap::test_start_stop_node": {"duration": {"avg": 60.0 }}},"status": "ok"},
            ...
            dict(
                json={"response": {"bootstrap_test.py::TestBootstrap::test_start_stop_node": {"duration": {"avg": 120.0 }}},"status": "ok"},
                status_code=200,
            ),
            dict(
                json={"response": {"bootstrap_test.py::TestBootstrap::test_start_stop_node": {"duration": {"avg": None }}},"status": "ok"},
                status_code=200,
            ),
