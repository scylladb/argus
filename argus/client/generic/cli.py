...
@click.option("--extra-headers", default={}, type=click.UNPROCESSED, callback=validate_extra_headers, help="extra headers to pass to argus, should be in json format")
def submit_run(api_key: str, base_url: str, id: str, build_id: str, build_url: str, started_by: str, scylla_version: str = None, extra_headers: dict):
...
@click.option("--scylla-version", required=False, default=None, help="Version of Scylla used for this job")
def finish_run(api_key: str, base_url: str, id: str, status: str, scylla_version: str = None, extra_headers: dict):
    client = ArgusGenericClient(auth_token=api_key, base_url=base_url, extra_headers=extra_headers)
...
def trigger_jobs(api_key: str, base_url: str, job_info_file: str, version: str, plan_id: str, release: str, extra_headers: dict):
    client = ArgusGenericClient(auth_token=api_key, base_url=base_url, extra_headers=extra_headers)
