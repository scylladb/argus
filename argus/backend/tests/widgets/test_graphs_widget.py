...
def test_graph_views_empty_view(api_client, empty_view):
    res = api_client.get(
...
def test_graph_views_with_test_no_graph_views(api_client, fake_test):
    name = f"graphs_view_{uuid.uuid4().hex[:8]}"
...
def test_graph_views_unknown_view_errors(api_client):
    res = api_client.get(
...
def test_graph_views_with_seeded_graph_view(api_client, seeded_view_with_run, graph_view_for_test):
