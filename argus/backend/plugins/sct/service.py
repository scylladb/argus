...
class SCTService:
    ...
    @staticmethod
    def create_coredump_link(event_message: str, event_ts: datetime = None) -> CoredumpLink | None:
        ...
        if core_url_match:
            node_name = node_name_match.group("name") if node_name_match else f"unknown-node-{uuid4()}"
