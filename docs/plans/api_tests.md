...
| 12  | `argus/backend/controller/view_api.py`                    | `argus/backend/tests/view_api/test_view_api.py`                   | `partial`  | 18 tests covering `/api/v1/views/{,/create,/get,/all,/update,/delete,/search,/<id>/{versions,images,resolve,resolve/tests,pytest/results}}`. Item parsing exercised for `release:`/`group:`/`test:` prefixes; verification done via paired GET endpoints. Error paths cover missing/unknown ids and duplicate names. `/views/stats` deferred (requires ViewStatsCollector setup).                                                                                                                                                                                                                                                                                           |
