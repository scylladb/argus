...
| 21  | `argus/backend/controller/main.py` (profile only)         | `argus/backend/tests/main_api/test_profile.py`                    | `partial`  | Covered: `/profile/update/{name,username,email,password,picture}` (success + validation paths), `/storage/picture/<id>` (success, 404 on missing file, 500 on unknown id). Deferred: `/profile/`, `/profile/jobs`, `/profile/schedules` template renders, `/profile/oauth/github` callback, `/profile/create`.                                                                                                                                                                                                                                                                                                                                                              |
