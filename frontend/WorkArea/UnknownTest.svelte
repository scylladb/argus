...
<div class="rounded shadow-sm p-1 bg-light-three">
    <h4>Unknown plugin: <span class="d-inline-block bg-light-one rounded p-1 text-danger">"{testInfo.test.plugin_name}"</span></h4>
    <div><button class="btn btn-danger" on:click={() => dispatch("closeRun", { id: runId })}>Close</button></div>
