...
<div>
    ...
    <div class="w-100">
        <PytestTableWidget {testData} {fetching} filterString={widgetState.query || ""} on:testNameUpdated={handleTestNameUpdate} on:queryUpdated={handleQueryUpdate} on:markerSelect={handleMarkerClick} on:filterSelect={handleFilterClick}/>
    </div>
</div>
