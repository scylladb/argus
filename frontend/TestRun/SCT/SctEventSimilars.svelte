<script lang="ts">
    ...
    interface SimilarEventExtended extends SCTEvent {
        build_id?: string;
        start_time?: string;
        version?: string;
        issues?: Array<{
                                ...
                                <tr>
                                    ...
                                    <td class="date-column">
                                        {#if similarEvent.start_time}
                                            {new Date(similarEvent.start_time).toLocaleDateString("en-CA")}
                                        {:else}
                                            -
                                        {/if}
                                    </td>
                                                ...
                                                <div class="mb-1 d-flex align-items-center">
                                                    <div class="btn-group" style="width: 128px">
                                                        <button
                                                            ...
                                                            onclick={() => console.log(issue.url) || issueAttach?.(issue.url)}
                                                        >
                                                            <Fa icon={faPlus}/>
                                                        </button>
                                                        <a
